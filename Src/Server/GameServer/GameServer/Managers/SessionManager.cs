...
namespace GameServer.Managers
{
    class SessionManager : Singleton<SessionManager>
    {
        ...
        public void AddSession(int characterId, NetConnection<NetSession> session) { this.Sessions[characterId] = session; }

        public void RemoveSession(int characterId) { this.Sessions.Remove(characterId); }
