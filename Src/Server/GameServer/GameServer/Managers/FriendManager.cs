...
namespace GameServer.Managers
{
    class FriendManager
    {
        ...
        public void GetFriendsInfo(List<NFriendInfo> list)
        {
        ...
        public NFriendInfo GetFriendInfo(TCharacterFriend friend)
        {
            ...
            Log.InfoFormat("{0}:{1} GetFriendInfo:{2}:{3} Status:{4}", this.Owner.Id, this.Owner.Info.Name, friendInfo.friendInfo.Id, friendInfo.friendInfo.Id, friendInfo.Status);
            return friendInfo;
        }
